...
<main class="l-blogMain">
  ...
  <div class="l-blogContents">
    ...
    if($count!=0){
      // 検索結果を表示:該当記事あり
      echo '<p class="blogItem__title">＜<strong>'.$key.'</strong>＞で検索した結果、<strong>'.$count.'</strong>件の記事が見つかりました。</p>';
    }
    else {
      // 検索結果を表示:該当記事なし
      echo '<p class="blogItem__title">＜<strong>'.$key.'</strong>＞で検索した結果、関連する記事は見つかりませんでした。</p>';
    }
    ?>
  </div>
